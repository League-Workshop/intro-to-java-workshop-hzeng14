	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			if (attack.equalsIgnoreCase("Yell")) {
				JOptionPane.showMessageDialog(null, "You attack the dragon with a yell!");
			...
			if (attack.equalsIgnoreCase("Kick")) {
				JOptionPane.showMessageDialog(null, "You attack the dragon with a kick!");
				// -- Find a random number between 0 and 25 and store it in dragonDamage
				int num2 = gen.nextInt(25);
				// -- Subtract that number from the dragon's health variable
				dragonHealth = dragonHealth - num2;

				// 11. Find a random number between 0 and 35 and store it in playerDamage
				int num3 = gen.nextInt(35);
				// 12. Subtract this number from the player's health
				playerHealth = playerHealth - num3;
			}
		}

		// 13. If the user's health is less than or equal to 0
		if (playerHealth <= 0) {
			JOptionPane.showMessageDialog(null, "You lost and the dragon won...");
			// -- Tell the user that they lost
		}
		// 14. Else if the dragon's health is less than or equal to 0
		if (dragonHealth <= 0) {
			JOptionPane.showMessageDialog(null, "You won and took a ton of gold!");
