...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "If you find yourself having to cross and piranha-infested river, here's how to do it");
...
String place=JOptionPane.showInputDialog("Name a place you like");
